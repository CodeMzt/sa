...
typedef struct {
    float A;  /* sin(q2) 项系数 */
    float B;  /* sin(q2+q3) 项系数 */
    float C;  /* sin(q2+q3+q4) 项系数 */
} grav_param_t;
 ...
 *       tau2 = A*sin(q2) + B*sin(q2+q3) + C*sin(q2+q3+q4)
 *       tau3 = B*sin(q2+q3) + C*sin(q2+q3+q4)
 *       tau4 = C*sin(q2+q3+q4)
 */
 ...
 * @param gp 参数结构体指针
 * @param A sin(q2) 项系数
 * @param B sin(q2+q3) 项系数
 * @param C sin(q2+q3+q4) 项系数
 */
