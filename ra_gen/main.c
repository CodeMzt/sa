...
#include "task.h"
#include "semphr.h"
extern void can_comms_create(void);
extern TaskHandle_t can_comms;
extern void net_connect_create(void);
extern TaskHandle_t net_connect;
extern void log_task_create(void);
extern TaskHandle_t log_task;
extern void screen_interact_create(void);
extern TaskHandle_t screen_interact;
extern void wifi_debug_create(void);
